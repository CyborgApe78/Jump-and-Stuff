...
@onready var _screenshot := $MarginContainer/VBox/TextureRect
@onready var _screenshot_check = $MarginContainer/VBox/CheckBox
@onready var _mail : LineEdit = $MarginContainer/VBox/Mail/LineEdit
@onready var _http := $MarginContainer/HTTPRequest
@onready var _send_button = $MarginContainer/VBox/SendButton
...
func _on_SendButton_pressed():
	...
	var messagetype := tr($MarginContainer/VBox/OptionButton.text)
	var message : String = $MarginContainer/VBox/Message.text.replace("```", "")
...
func _on_HTTPRequest_request_completed(result, response_code, headers, body):
	...
	if clear_after_send:
		_mail.clear()
		$MarginContainer/VBox/Message.text = ""
